...
static SEXP _rpkgcpp_add_cpp_try(SEXP xSEXP, SEXP ySEXP) {
BEGIN_RCPP
...
RcppExport SEXP _rpkgcpp_add_cpp(SEXP xSEXP, SEXP ySEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_rpkgcpp_add_cpp_try(xSEXP, ySEXP));
    }
...
RcppExport SEXP _rpkgcpp_approx_pi(SEXP NSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static int _rpkgcpp_RcppExport_validate(const char* sig) { 
...
RcppExport SEXP _rpkgcpp_RcppExport_registerCCallable() { 
    R_RegisterCCallable("rpkgcpp", "_rpkgcpp_add_cpp", (DL_FUNC)_rpkgcpp_add_cpp_try);
    R_RegisterCCallable("rpkgcpp", "_rpkgcpp_RcppExport_validate", (DL_FUNC)_rpkgcpp_RcppExport_validate);
    return R_NilValue;
}
...
RcppExport void R_init_rpkgcpp(DllInfo *dll) {
